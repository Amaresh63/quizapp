...
public class Quiz {
	...
	public Quiz(Integer id, String category, String difficultyLevel, String option1, String option2, String option3,
	...
	public String toString() {
		return "Quiz [id=" + id + ", category=" + category + ", difficultyLevel=" + difficultyLevel + ", option1="
